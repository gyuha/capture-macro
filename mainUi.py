...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.leMonitor = QtWidgets.QLineEdit(self.centralwidget)
        self.leMonitor.setObjectName("leMonitor")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.leMonitor)
        ...
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.label_9)
        self.hsImageQuality = QtWidgets.QSlider(self.centralwidget)
        self.hsImageQuality.setMinimum(60)
        self.hsImageQuality.setMaximum(100)
        ...
        self.lbImageQuality = QtWidgets.QLabel(self.centralwidget)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.macroTable)
        ...
        self.lbPreview.setSizeIncrement(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "모니터 번호"))
        self.leMonitor.setText(_translate("MainWindow", "0"))
        self.leMonitor.setPlaceholderText(_translate("MainWindow", "모니터 번호"))
        self.label_7.setText(_translate("MainWindow", "중복"))
        self.leSameCount.setText(_translate("MainWindow", "3"))
        self.label_9.setText(_translate("MainWindow", "- 연속으로 같은 이미지 일 경우 중단"))
        self.label_10.setText(_translate("MainWindow", "이미지 압축율"))
        self.lbImageQuality.setText(_translate("MainWindow", "80"))
