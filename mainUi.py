...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.leScreenRect = QtWidgets.QLineEdit(self.centralwidget)
        self.leScreenRect.setObjectName("leScreenRect")
        self.gridLayout_3.addWidget(self.leScreenRect, 0, 0, 1, 1)
        self.btnScreenRect = QtWidgets.QPushButton(self.centralwidget)
        self.btnScreenRect.setObjectName("btnScreenRect")
        self.gridLayout_3.addWidget(self.btnScreenRect, 0, 1, 1, 1)
        ...
        self.lbActiveWindowName = QtWidgets.QLineEdit(self.centralwidget)
        self.lbActiveWindowName.setObjectName("lbActiveWindowName")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lbActiveWindowName)
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setObjectName("label_9")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_9)
        self.gridLayout_2 = QtWidgets.QGridLayout()
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.leClickPoint = QtWidgets.QLineEdit(self.centralwidget)
        self.leClickPoint.setObjectName("leClickPoint")
        self.gridLayout_2.addWidget(self.leClickPoint, 0, 0, 1, 1)
        self.btnPointClick = QtWidgets.QPushButton(self.centralwidget)
        self.btnPointClick.setObjectName("btnPointClick")
        self.gridLayout_2.addWidget(self.btnPointClick, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "캡처 위치"))
        self.btnScreenRect.setText(_translate("MainWindow", "영역 선택"))
        ...
        self.label_9.setText(_translate("MainWindow", "클릭 위치"))
        self.btnPointClick.setText(_translate("MainWindow", "포인트 선택"))
